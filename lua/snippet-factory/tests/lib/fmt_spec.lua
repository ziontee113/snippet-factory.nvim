-- Copied from https://github.com/L3MON4D3/LuaSnip/blob/master/tests/unit/fmt_spec.lua
...
describe("fmt.interpolate", function()
	...
	works("do not trim placeholders with whitespace", "a{ something}b{}c", { 2, [" something"] = 1 }, "a1b2c")
